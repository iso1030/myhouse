...
insert into mh_house (id, code, address, price, area, bedrooms, open_time, create_time, last_update_time, lastd2upload_time, lastd3upload_time, bg_music, cover_img, uid) 
	values(1, 'f7f96f8f5c914ddea072cc814df87fbd', 'test adress1', 1000, 100, '2room1ting', 0, 0, 0, 0, 0, '', '', 1);
insert into mh_house (id, code, address, price, area, bedrooms, open_time, create_time, last_update_time, lastd2upload_time, lastd3upload_time, bg_music, cover_img, uid) 
	values(2, '69e896b50ba9434b924bed1595aa8a2e', 'test adress2', 1010, 110, '2room1ting', 0, 0, 0, 0, 0, '', '', 2);
insert into mh_house (id, code, address, price, area, bedrooms, open_time, create_time, last_update_time, lastd2upload_time, lastd3upload_time, bg_music, cover_img, uid) 
	values(3, '69e896b50ba9434b924bed1595aa8a2e', 'test adress3', 1010, 110, '2room1ting', 0, 0, 0, 0, 0, '', '', 2);
