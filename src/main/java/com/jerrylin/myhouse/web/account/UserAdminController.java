 ...
 *******************************************************************************/
package com.jerrylin.myhouse.web.account;
...
import com.jerrylin.myhouse.service.account.AdminService;
...
public class UserAdminController {
	...
	public String update(@Valid @ModelAttribute("user") Admin user, RedirectAttributes redirectAttributes) {
	...
	public String delete(@PathVariable("id") Long id, RedirectAttributes redirectAttributes) {
		Admin user = adminService.getAdmin(id);
